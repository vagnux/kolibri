...
// Website URL
config::set("siteRoot",'http://' . $_SERVER['HTTP_HOST'] . '/kolibri/Kolibri-v0.8.2/');
#config::set("siteRoot",'http://' . $_SERVER['HTTP_HOST'] . '/');
// --------------------------------------------------------------------------------------------//Website Name
config::set ( "siteName", 'Kolibri Framework' );
// --------------------------------------------------------------------------------------------// Default Controller
