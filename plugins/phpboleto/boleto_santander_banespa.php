...
// N�O ALTERAR!
include("../Kolibri-v0.8.2/plugins/phpboleto/include/funcoes_santander_banespa.php"); 
include("../Kolibri-v0.8.2/plugins/phpboleto/include/layout_santander_banespa.php");
?>
